...
# Apply Bag of words (TfIdf_vectorizer)
def apply_tfidf(X_train, y_train, y_test,X_test, max_features):
...
def main():
    ...
    train_df, test_df=apply_tfidf(X_train, y_train, y_test,X_test, max_features)
